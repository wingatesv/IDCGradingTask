# -*- coding: utf-8 -*-
"""V2 Weighted_400x_CNN _EfficientNet_B0.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1UKeBdQspGxhuoYTbGVqu105XSczpQJbj
    
This is a sample for model cv training and testing, the directories are for private usage purpose only
"""
...
model_name = "efficientnet_b0" # @param ['efficientnetv2-s', 'efficientnetv2-m', 'efficientnetv2-l', 'efficientnetv2-s-21k', 'efficientnetv2-m-21k', 'efficientnetv2-l-21k', 'efficientnetv2-xl-21k', 'efficientnetv2-b0-21k', 'efficientnetv2-b1-21k', 'efficientnetv2-b2-21k', 'efficientnetv2-b3-21k', 'efficientnetv2-s-21k-ft1k', 'efficientnetv2-m-21k-ft1k', 'efficientnetv2-l-21k-ft1k', 'efficientnetv2-xl-21k-ft1k', 'efficientnetv2-b0-21k-ft1k', 'efficientnetv2-b1-21k-ft1k', 'efficientnetv2-b2-21k-ft1k', 'efficientnetv2-b3-21k-ft1k', 'efficientnetv2-b0', 'efficientnetv2-b1', 'efficientnetv2-b2', 'efficientnetv2-b3', 'efficientnet_b0', 'efficientnet_b1', 'efficientnet_b2', 'efficientnet_b3', 'efficientnet_b4', 'efficientnet_b5', 'efficientnet_b6', 'efficientnet_b7', 'bit_s-r50x1', 'inception_v3', 'inception_resnet_v2', 'resnet_v1_50', 'resnet_v1_101', 'resnet_v1_152', 'resnet_v2_50', 'resnet_v2_101', 'resnet_v2_152', 'nasnet_large', 'nasnet_mobile', 'pnasnet_large', 'mobilenet_v2_100_224', 'mobilenet_v2_130_224', 'mobilenet_v2_140_224', 'mobilenet_v3_small_100_224', 'mobilenet_v3_small_075_224', 'mobilenet_v3_large_100_224', 'mobilenet_v3_large_075_224']
...
#for cv
save_model = f"/content/drive/MyDrive/Wingates FYP/Codes Files/Own Codes/V2_{model_name}_CrossValidation400x_"
print(save_model)
#for test set
checkpoint_path = f'/content/drive/MyDrive/Wingates FYP/Codes Files/Own Codes/v2_cp_{model_name}_400x_CV.h5'
...
df.to_csv(f'/content/drive/MyDrive/Wingates FYP/CSV2/{model_name}_result.csv', index=False)

metrics = {'Balanced Accuracy': [], 'Macro Precision': [], 'Macro Recall': [], 'Macro F1score': [], 'Kappa Score': []}
df = pd.DataFrame(metrics) 
df.to_csv('/content/drive/MyDrive/Wingates FYP/CSV2/test_result.csv', index=False)
